...
And(/^I complete the form$/) do
  @student_request = {:minor=>"None", :expected_graduation=>"2019 Fall", :request_semester=>"2020 Fall", :course_id=>"629", :section_id => "600"}
...
And(/^I complete the form the second time$/) do
  @student_request = {:minor=>"None", :expected_graduation=>"2019 Fall", :request_semester=>"2020 Fall", :course_id=>"630", :section_id => "600"}
  page.has_content?("123123123")
  select(@student_request[:expected_graduation], from:'Expected Graduation*')
  select(@student_request[:request_semester], from:'Request Semester*')
  fill_in('Course Id*', :with => @student_request[:course_id])
...
And(/^I complete the form the third time$/) do
  @student_request = {:minor=>"None", :expected_graduation=>"2019 Fall", :request_semester=>"2020 Fall", :course_id=>"631", :section_id => "600"}
  page.has_content?("123123123")
  select(@student_request[:expected_graduation], from:'Expected Graduation*')
  select(@student_request[:request_semester], from:'Request Semester*')
  fill_in('Course Id*', :with => @student_request[:course_id])
...
And(/^I complete the form the fourth time$/) do
  @student_request = {:minor=>"None", :expected_graduation=>"2019 Fall", :request_semester=>"2020 Fall", :course_id=>"632", :section_id => "600"}
  page.has_content?("123123123")
  select(@student_request[:expected_graduation], from:'Expected Graduation*')
  select(@student_request[:request_semester], from:'Request Semester*')
  fill_in('Course Id*', :with => @student_request[:course_id])
...
And(/^I assign priority to the request$/) do
  @student_request = {:minor=>"None", :expected_graduation=>"2019 Fall", :request_semester=>"2020 Fall", :course_id=>"606", :section_id => "600" , :priority => "High"}
  page.has_content?("123123123")
  select(@student_request[:expected_graduation], from:'Expected Graduation*')
  select(@student_request[:request_semester], from:'Request Semester*')
  fill_in('Course Id*', :with => @student_request[:course_id])
